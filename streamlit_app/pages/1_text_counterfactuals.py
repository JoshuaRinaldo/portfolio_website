...
predicted label has a score that is greater that 0.5. If none of the
...
if st.button("Press to generate counterfactuals"):
    ...
    display_text = create_hex_css(explanation=explanation, desired_label="LABEL_2", undesired_label="LABEL_0")
